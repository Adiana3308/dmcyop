...
int main()
{
    ...
    // childCount-> to calculate the attribute table of selected attribute.
    ...
    while (getline(file, line))
    {
        ...
        // now calculate the freq of categorical class.
        parentCounts[playtennis]++;
        // freq of values of categorical class for the chosen attribute
